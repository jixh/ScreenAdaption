package com.jktaihe.screenadaption;
...
public class GenerateValueFiles {
	...
	private void generateXmlFile(int w, int h) {
		...
		StringBuffer sbForSP = new StringBuffer();
		sbForSP.append("<?xml version=\"1.0\" encoding=\"utf-8\"?>\n");
		sbForSP.append("<resources>");
		...
		File layxFile = new File(fileDir.getAbsolutePath(), "lay_w.xml");
		File layyFile = new File(fileDir.getAbsolutePath(), "lay_h.xml");
